...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__services_task_service__["a" /* TaskService */]],
...
module.exports = "<div class=\"card\">\n  <div class=\"card-body\">\n    <form (submit)=\"addTasks($event)\">\n      <div class=\"input-group\">\n        <input type=\"text\" name=\"title\" [(ngModel)]=\"title\" placeholder=\"Add Task\" class=\"form-control\">\n        <span class=\"input-group-addon\">\n          <button type=\"submit\" class=\"btn btn-primary\">Add Task</button>\n        </span>\n      </div>\n    </form>\n  </div>\n</div>\n\n<table class=\"table\">\n  <thead>\n    <tr>\n      <th>Status</th>\n      <th>Title</th>\n      <th>Operations</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr *ngFor=\"let task of tasks\">\n      <td><input type=\"checkbox\" [checked]=\"task.isDone\" (click)=\"updateTask(task)\"></td>\n      <td>{{task.title}}</td>\n      <td><button (click)=\"deleteTask(task._id)\" class=\"btn btn-danger\" type=\"submit\"><i class=\"fa fa-trash\"></i></button></td>\n    </tr>\n  </tbody>\n</table>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_task_service__ = __webpack_require__("../../../../../src/app/services/task.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var TasksComponent = (function () {
    ...
    TasksComponent.prototype.addTasks = function (event) {
        ...
        this.taskService.addTasks(newTask).subscribe(function (task) {
    ...
    TasksComponent.prototype.updateTask = function (task) {
        ...
        this.taskService.updateTasks(newTask).subscribe(function (res) {
    ...
    TasksComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__services_task_service__["a" /* TaskService */]])
    ], TasksComponent);
...
var TaskService = (function () {
    ...
    ;
    TaskService.prototype.updateTasks = function (newTask) {
